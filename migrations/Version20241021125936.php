...
final class Version20241021125936 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE product (id SERIAL NOT NULL, brand_id INT DEFAULT NULL, name VARCHAR(65) NOT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
